...
//Mercator --BEGIN--
	  ...
	  function getNewRadius() {
	      //console.log('in getnewRadius');
		  //console.log(desiredRadiusPerPointInMeters);
...
//		  console.log('out getnewRadius '+totalPixelSize);
	...
	//console.log('entrei');
        ...
        //console.log(vPointFillColor);
     	function ShowCircles() {
		    //console.log('in show circles');
			...
			console.log("zoom show point "+ZoomLeveltoShowPoint);
				
			if (zoomlevel >= ZoomLeveltoShowPoint) {
			    console.log("entrei zoom_" );
				...
				if (bounds != null) {
					...
					// Get the distance between the center of the map and your markers
						...
						//console.log('loop circle data '+ i);
